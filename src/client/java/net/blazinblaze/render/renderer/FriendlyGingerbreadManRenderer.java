...
public class FriendlyGingerbreadManRenderer extends AbstractZombieRenderer<FriendlyGingerbreadMan, ZombieRenderState, ZombieModel<ZombieRenderState>> {
    ...
    public FriendlyGingerbreadManRenderer(EntityRendererProvider.Context context) {
    ...
    public FriendlyGingerbreadManRenderer(EntityRendererProvider.Context context, ModelLayerLocation modelLayerLocation, ModelLayerLocation modelLayerLocation2, ModelLayerLocation modelLayerLocation3, ModelLayerLocation modelLayerLocation4, ModelLayerLocation modelLayerLocation5, ModelLayerLocation modelLayerLocation6) {
