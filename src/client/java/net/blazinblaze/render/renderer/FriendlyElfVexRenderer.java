...
public class FriendlyElfVexRenderer extends MobRenderer<FriendlyElfVex, VexRenderState, ElfVexModel> {
    ...
    public FriendlyElfVexRenderer(EntityRendererProvider.Context context) {
        super(context, new ElfVexModel(context.bakeLayer(BCMModelLayers.ELF_VEX)), 0.3F);
        this.addLayer(new ItemInHandLayer<>(this));
    }

    protected int getBlockLightLevel(FriendlyElfVex vexEntity, BlockPos blockPos) {
        return 15;
    }
    ...
    public void extractRenderState(FriendlyElfVex vexEntity, VexRenderState vexEntityRenderState, float f) {
