...
public class EtherealSnowball extends Item implements ProjectileItem {
    public EtherealSnowball(Item.Properties settings) {
        super(settings);
    }
    ...
    public InteractionResult use(Level level, Player player, InteractionHand interactionHand) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            Projectile.spawnProjectileFromRotation(EtherealSnowballEntity::new, serverLevel, itemStack, player, 0.0F, PROJECTILE_SHOOT_POWER, 1.0F);
        }
    ...
    public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
        return new EtherealSnowballEntity(world, pos.x(), pos.y(), pos.z(), stack);
    }
}
