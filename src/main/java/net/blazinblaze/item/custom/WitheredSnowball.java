...
public class WitheredSnowball extends Item implements ProjectileItem {
    public WitheredSnowball(Item.Properties settings) {
        super(settings);
    }
    ...
    public InteractionResult use(Level level, Player player, InteractionHand interactionHand) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            Projectile.spawnProjectileFromRotation(WitheredSnowballEntity::new, serverLevel, itemStack, player, 0.0F, PROJECTILE_SHOOT_POWER, 1.0F);
        }
    ...
    public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
        return new WitheredSnowballEntity(world, pos.x(), pos.y(), pos.z(), stack);
    }
}
