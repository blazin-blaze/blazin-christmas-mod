...
public class FierySnowball extends Item implements ProjectileItem {
    public FierySnowball(Item.Properties settings) {
        super(settings);
    }
    ...
    public InteractionResult use(Level level, Player player, InteractionHand interactionHand) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            Projectile.spawnProjectileFromRotation(FierySnowballEntity::new, serverLevel, itemStack, player, 0.0F, PROJECTILE_SHOOT_POWER, 1.0F);
        }
    ...
    public Projectile asProjectile(Level world, Position pos, ItemStack stack, Direction direction) {
        return new FierySnowballEntity(world, pos.x(), pos.y(), pos.z(), stack);
    }
}
