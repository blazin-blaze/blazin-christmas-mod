...
public class BCMItems {
    ...
    public static final Item JOLLY_ESSENCE = register("jolly_essence", EnchantedEffectItem::new, new Item.Properties().rarity(Rarity.RARE));
    ...
    public static final Item SNOWFLAKE = register("snowflake", Item::new, new Item.Properties().stacksTo(16));
